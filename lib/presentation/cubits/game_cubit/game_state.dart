  ...
  int get size {
    switch (this) {
      ...
      case GameDifficult.hard:
        return 5;
      case GameDifficult.extremeLevel:
        return 6;
    }
  }
}
...
class GameState extends Equatable {
  const GameState({required this.size, required this.puzzle, required this.moves, required this.status, required this.imageData, required this.alienName});
